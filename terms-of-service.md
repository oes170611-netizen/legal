...
When you use NutriCore, you are agreeing to these Terms of Service ("Terms"). Violation of these Terms may, at our discretion, result in termination of your account.

We may update these Terms at any time. If we make significant changes, we will refresh the date at the top of this page and, where required, notify you in-app or by email.

---

## Definitions

**"We," "us," "our,"** or **"the NutriCore team"** refers to the individual(s) building and maintaining NutriCore.

**"Services"** refers to the NutriCore mobile app and any associated backend services, whether delivered via Android, web, or another format.

**"You"** or **"your"** refers to the person who owns or uses a NutriCore account.
...
- We cannot and will not be liable for any loss or damage arising from your failure to keep your login credentials secure.
- You are responsible for all content and activity that occurs under your account.
- You must provide a valid email address to register, and confirm it via the verification step before your account becomes active.

---

## Cost and Payment

NutriCore is currently free to use. We do not ask for your credit card, and we do not sell your data. The app may display ads (via Google AdMob) to support the Service, including optional rewarded ads that unlock in-app perks.

If we introduce paid plans or in-app purchases in the future, we'll update these Terms accordingly before doing so, and any paid feature will be clearly marked before you're charged.
...
We intend to keep maintaining NutriCore for the long haul, but as a small/independent team, we reserve the right to modify, discontinue, or redesign any part of the Service — temporarily or permanently — with or without notice. We'll do our best to give you a heads-up on anything significant.
...
- **Your content.** Anything you log in NutriCore — food entries, weight, workouts, chat messages — remains yours. You give us a limited license to use that content solely to provide the Service to you (e.g., storing it, running calculations on it, and passing relevant context to our AI provider to generate assistant responses). We claim no ownership over your content.
- **Exercise reference data.** Exercise names, instructions, and images shown in the app are sourced from the [free-exercise-db](https://github.com/yuhonas/free-exercise-db) project, released under the Unlicense (public domain). This is third-party reference content displayed in the app, not something we claim ownership of or that you contribute.
- **Our content.** We (or our licensors) own all right, title, and interest in the Service itself — code, design, branding — and you get no ownership rights in it through your use of the app. You may not copy, duplicate, or reuse any part of the app's design, code, or branding without our written permission.
- You agree not to reproduce, resell, or exploit any part of the Service without our express written permission.
...
If you have a question about these Terms, contact us at **nutricoreapp1@gmail.com**.
